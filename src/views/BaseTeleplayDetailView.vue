...
<template>
    <div class="container">
        ...
        <base-num-collect-swiper-module :data="playData" @popup="collectPopupFlag=true"></base-num-collect-swiper-module>  
